      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="animate-fade-in-up">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center w-[260px] sm:w-auto mx-auto">
            <Link
              to="/contact"
              onClick={() => analytics.ctaClick("hero_consultation")}
              className="btn-primary w-full sm:w-auto text-sm px-5 py-2.5 sm:text-base sm:px-8 sm:py-3"
            >
              Schedule Consultation
            </Link>
            <Link
              to="/portfolio"
              onClick={() => analytics.ctaClick("hero_view_portfolio")}
